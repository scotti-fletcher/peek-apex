...
CREATE TABLE  "TREES" 
   (	"ID" NUMBER, 
	"PARENT_NODES" VARCHAR2(1000) COLLATE "USING_NLS_COMP", 
	"NODE_NAME" VARCHAR2(400) COLLATE "USING_NLS_COMP", 
	"NODE_COLOR" VARCHAR2(45) COLLATE "USING_NLS_COMP", 
	"NODE_SIZE" NUMBER, 
	"NODE_TOOLTIP" VARCHAR2(5000) COLLATE "USING_NLS_COMP", 
	"PATH_HELPER" VARCHAR2(2000) COLLATE "USING_NLS_COMP", 
	"TREE_NAME" VARCHAR2(400) COLLATE "USING_NLS_COMP", 
	"TREE_TYPE" VARCHAR2(100) COLLATE "USING_NLS_COMP", 
	"NODE_LINK" VARCHAR2(100) COLLATE "USING_NLS_COMP"
   )  DEFAULT COLLATION "USING_NLS_COMP";
